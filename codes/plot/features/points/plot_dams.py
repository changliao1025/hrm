...
iFiletype_in=1
sFilename_in='/compyfs/liao313/00raw/dam/GOODD_data/Data/GOOD2_dams.geojson'

sFilename_output_in= '/qfs/people/liao313/workspace/python/hrm/data/output/large_dams.png'


aExtent = [-125.0, -112.0, 41.0, 49.0]
...
map_vector_point_file(iFiletype_in,
                          ...
                          sTitle_in='Major dams',
                          iFlag_zebra_in = 1,
                          iFlag_size_in = 1,
                          iDPI_in=None,
                          sField_size_in='drainage',
