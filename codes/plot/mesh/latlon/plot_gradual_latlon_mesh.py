...
dLongitude_center = -77.1
dLatitude_center = 41.1

iFiletype_in=1
sFilename_in='/qfs/people/liao313/workspace/python/hrm/data/output/latlon/latlon_gradual.geojson'
sFilename_boundary = '/qfs/people/liao313/workspace/python/hrm/data/output/latlon/boundary.geojson'
sFilename_output_in= '/qfs/people/liao313/workspace/python/hrm/data/output/latlon/latlon_gradual.png'
...
map_vector_polygon_file(iFiletype_in,
                        ...
                        dLongitude_highligt_in=dLongitude_center,
                         dLatitude_highlight_in=dLatitude_center,
                          ...
                          sTitle_in='Variable-resolution Latlon Mesh',
                          iFlag_zebra_in = 1,
                          iFlag_fill_in = 0,
                          iDPI_in=None,
