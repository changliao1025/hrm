...
iFiletype_in=1
sFilename_in='/qfs/people/liao313/workspace/python/hrm/data/output/triangular/triangular.geojson'
sFilename_boundary = '/qfs/people/liao313/workspace/python/hrm/data/output/triangular/boundary.geojson'
sFilename_output_in= '/qfs/people/liao313/workspace/python/hrm/data/output/triangular/triangular.png'
...
map_vector_polygon_file(iFiletype_in,
                        ...
                        dLongitude_highligt_in=dLongitude_center,
                         dLatitude_highlight_in=dLatitude_center,
                          ...
                          sTitle_in='Structured Triangular Mesh',
                          iFlag_zebra_in = 1,
                          iFlag_fill_in = 0,
                          iDPI_in=None,
