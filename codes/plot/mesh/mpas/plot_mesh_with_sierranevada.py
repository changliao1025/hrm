...
sFilename_river_network = '/compyfs/liao313/00raw/hydrology/hydroshed/hydrobasin/geojson/hybas_lake_all_lev03.geojson'
aFilename_in = [sFilename_mesh, sFilename_river_network]
sFilename_output_in = '/qfs/people/liao313/workspace/python/hrm/data/output/mpas/mpas_mesh_sierranevada.png'
...
map_multiple_vector_files(aFiletype_in,
                             ...
                             iFlag_relief_image_in=1,
                             iBasemap_zoom_level_in=None,
                             iFont_size_in=None,
                             sColormap_in = None,
                             sTitle_in = 'Sierra Nevada',
                             iDPI_in = None,
                             iSize_x_in = None,
                             iSize_y_in = None,
