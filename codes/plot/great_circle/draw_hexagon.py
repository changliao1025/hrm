...
#define a hexagon on the sphere using six points

pt1= dict()
pt1['dLongitude_degree'] = -130
pt1['dLatitude_degree'] = 70

pt2= dict()
pt2['dLongitude_degree'] = -120
pt2['dLatitude_degree'] = 70

pt3= dict()
pt3['dLongitude_degree'] = -110
pt3['dLatitude_degree'] = 75

pt4= dict()
pt4['dLongitude_degree'] = -120
pt4['dLatitude_degree'] = 80

pt5= dict()
pt5['dLongitude_degree'] = -130
pt5['dLatitude_degree'] = 80

pt6= dict()
pt6['dLongitude_degree'] = -140
pt6['dLatitude_degree'] = 75
...
if iFlag_create_cell == 1:
    ...
    pRing.AddPoint(pVertex5.dLongitude_degree, pVertex5.dLatitude_degree)
    pRing.AddPoint(pVertex6.dLongitude_degree, pVertex6.dLatitude_degree)
    pRing.AddPoint(pVertex1.dLongitude_degree, pVertex1.dLatitude_degree)
...
sFilename_output_in = os.path.join(sWorkspace_output, 'hexagon.png')
...
aVertex.append(pVertex5)
aVertex.append(pVertex6)
