...
pt2= dict()
pt2['dLongitude_degree'] = -115
pt2['dLatitude_degree'] = 40

pt3= dict()
pt3['dLongitude_degree'] = -122.5
...
sFilename = os.path.join(sWorkspace_output, 'triangular.geojson')
iFlag_create_cell = 1
...
sFilename_output_in = os.path.join(sWorkspace_output, 'triangular.png')
