...
from codes.shared.create_nested_latlon_mesh import create_nested_latlon_mesh
...
sWorkspace_out = '/qfs/people/liao313/workspace/python/hrm/data/output/latlon'
sFilename_output_in = os.path.join(sWorkspace_out, 'latlon_nested.geojson')

create_nested_latlon_mesh(dLongitude_left_in,
                       dLatitude_bot_in,
                       dResolution_degree_in,
                       ncolumn_in, nrow_in,
                       sFilename_output_in,
                       iColumn_index_highlight_in=4,
                          iRow_index_highlight_in=4,
                          nNested = 4)