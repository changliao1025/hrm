...
sFilename_output_in = os.path.join(sWorkspace, 'elevation_drt_std_conus.png')
#sFilename_output_in = os.path.join(sWorkspace, 'elevation_drt_std_sierranevada.png')
aLegend_in = list()
aLegend_in.append('(a)')
...
if iFlag_drt == 1:
    map_vector_polygon_file(1, sFilename_drt,
                             ...
                             sTitle_in = 'Surface elevation (std)',
...
aLegend_in = list()
sFilename_output_in = os.path.join(sWorkspace, 'elevation_mpas_std_conus.png')
#sFilename_output_in = os.path.join(sWorkspace, 'elevation_mpas_std_sierranevada.png')
aLegend_in.append('(b)')
