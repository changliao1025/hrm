...
#sPath_subset = '/qfs/people/liao313/workspace/python/subset/'
#sys.path.append(sPath_subset)
...
sFilename_geojson_in = '/qfs/people/liao313/workspace/python/hrm/data/evaluation/watershed_boundary/drt_16th_mesh_wo_holes.geojson'
...
tStart = time.time()
sFilename_vector_out = '/qfs/people/liao313/workspace/python/hrm/data/evaluation/elevation/dem_subset_drt_8th.shp'
