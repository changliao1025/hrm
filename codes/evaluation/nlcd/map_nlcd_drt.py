...
sFilename_dem = '/qfs/people/liao313/workspace/python/hrm/data/evaluation/nlcd/nlcd_subset_drt_8th.geojson'
...
iFiletype_in=1
sFilename_output_in = '/qfs/people/liao313/workspace/python/hrm/data/evaluation/nlcd/nlcd_subset_drt_8th.png'
...
#set color for each land cover type using the same colar as in NLCD
aColor_discrete = {
...
sFilename_output_in = '/qfs/people/liao313/workspace/python/hrm/data/evaluation/nlcd/nlcd_subset_ntype_drt_8th.png'
...
map_vector_polygon_file(iFiletype_in,
                          ...
                          iFlag_filter_in = 0,
                          iDPI_in=600,
                          aLegend_in=['(a)', 'Structured Latlon mesh-based (1/8th)'],
                          dMissing_value_in=None,
