...
#sFilename_geojson_in = '/compyfs/liao313/04model/pyflowline/mississippi/pyflowline20241201001/mpas.geojson'
...
tStart = time.time()
sFilename_vector_out = '/qfs/people/liao313/workspace/python/hrm/data/evaluation/nlcd/nlcd_subset.shp'
