...
def create_drt_mesh(sFilename_parameter_in,
    ...
    aDrainage_area = np.zeros((nRow, nColumn), dtype=float)
    ...
    #create  field for drainage area
    pLayer.CreateField(ogr.FieldDefn('areaTotal2', ogr.OFTReal))
    ...
    for iRow in range(0, nRow, 1):
        for iColumn in range( 0, nColumn, 1):
            if aMask[iRow, iColumn] == 1:
                ...
                #set the area
                pFeature.SetField('areaTotal2', float(aDrainage_area[iRow, iColumn]))
...
if __name__ == '__main__':
    ...
    sFilename_geojson = '/qfs/people/liao313/workspace/python/hrm/data/evaluation/watershed_boundary/drt_16th_mesh_wo_holes_w_drainage.geojson'
    create_drt_mesh(sFilename_parameter, sFilename_geojson)
    pass
