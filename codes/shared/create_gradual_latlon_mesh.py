...
def create_gradual_latlon_mesh(dLongitude_left_in,
                       dLatitude_bot_in,
                       ncolumn_in, nrow_in,
                       aLongitude_left_in,
                       aLatitude_bottom_in,
    ...
    if pBoundary_in is None:
        ...
        y1 = dLatitude_bot_in
        x2 = aLongitude_left_in[ncolumn_in-1]
        y2 = y1
        x3 = x2
        y3 = aLatitude_bottom_in[nrow_in-1]
        x4 = x1
        y4 = y3
        ring.AddPoint(x1, y1)
        ring.AddPoint(x2, y2)
    ...
    for iRow in range(1, nrow_in+1):
        for iColumn in range(1, ncolumn_in+1):
            ...
            xspacing = aLongitude_left_in[iColumn] -  aLongitude_left_in[iColumn-1]
            yspacing = abs(aLatitude_bottom_in[iRow] - aLatitude_bottom_in[iRow-1])

            #define a polygon here
            x1 = aLongitude_left_in[iColumn-1]
            y1 = aLatitude_bottom_in[iRow-1] - yspacing
